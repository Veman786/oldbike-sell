...
namespace MCproject.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage ="phoneno must should be 10numbers", MinimumLength = 10)]

            [Display(Name = "Alternative Phoneno")]
        ...
        { 
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Assign user to a role as per checkbox selection
                    if(Input.IsAdmin)
                    {
